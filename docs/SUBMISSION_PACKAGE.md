...
`dist/h2-testlens-submission-v3.5.36.zip`

The verified SHA-256 is recorded in the adjacent `dist/h2-testlens-submission-v3.5.36.zip.sha256` sidecar. It is intentionally not repeated here because this document is itself included in the archive and would make an embedded checksum self-referential.
