...
|---|---|---|---|
| [GB/T 45541-2025](https://std.samr.gov.cn/gb/search/gbDetailed?id=31DA5F377BB68F08E06397BE0A0A4CFB) | PEM profile、基本检查/基础测试/性能测试/报告字段、字段映射、流量/纯度/能耗 KPI、阶段门控、仪器/校准/不确定度/签核字段入口 | 完整试验条件、仪器精度与量程、应急措施、企业验收计算、完整方法逐条实施证据 | 部分映射；不可宣称符合 |
