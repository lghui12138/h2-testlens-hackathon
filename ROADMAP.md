...
- Gate: `npm test` **171/171**, `npm run check:submission` **132/132**, typecheck, Vinext build 5/5 and package smoke install/test/typecheck/build/start/HTTP pass. API smoke now exercises AI client-parameter isolation, metricTrace, and runtime standard-evidence binding. The package receipt remains the source of truth for the final artifact SHA-256.
