...
- Trusted approval ledger is now an independent runtime gate; the repository intentionally has zero approved rows, so no self-declared profile can claim enterprise approval.
