...
- Gate: `npm test` **164/164**, `npm run check:submission` **127/127**, typecheck, build 5/5, package smoke and static preparation pass; the adjacent versioned release receipt contains the final artifact SHA-256.
