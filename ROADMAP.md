...
- Residual: GitHub Actions Run 82 successfully deployed `3f83261`, but the Pages workflow still does not run `package:submission`; the public receipt can bind the deployed commit/run without claiming a package artifact. Final live receipt readback remains pending while the custom domain is unreachable.
