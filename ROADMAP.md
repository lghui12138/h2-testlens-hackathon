...
- Residual: GitHub Actions Run 93 successfully executed the package-smoke hook and deployed the Pages artifact for the previous public baseline; this v3.5.38 commit requires a new cloud run. Custom-domain live readback remains pending while the domain is unreachable.
