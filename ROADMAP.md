...
- Gate: `npm test` **175/175**, `npm run check:submission` **132/132**, typecheck, Vinext build 5/5 and package smoke install/test/typecheck/build/start/HTTP pass. API smoke now exercises AI client-parameter isolation, metricTrace, runtime method-source binding and per-standard-reference evidence binding. The package receipt remains the source of truth for the final artifact SHA-256.
