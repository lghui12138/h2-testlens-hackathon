...
## v3.5.36 current continuation evidence
...
- Verification artifacts: v3.5.36 T02 coverage/reference/integration reports; 263/263 tests; new vehicle/stack/provenance/rendered-surface regressions; full submission gates remain required before packaging.
