...
> Current top-level status: **v3.5.72**. The historical phase rows below retain their original scope wording; current verification is recorded in the v3.5.72 continuation entries.
...
## v3.5.72 current continuation evidence
