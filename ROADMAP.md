...
- Gate: `npm test` **170/170**, `npm run check:submission` **129/129**, typecheck, Vinext build 5/5 and package smoke install/test/typecheck/build/start/HTTP pass. API smoke now exercises AI client-parameter isolation and metricTrace in analyze/batch/report. The package receipt remains the source of truth for the final artifact SHA-256.
