...
console.log(JSON.stringify({ archive, checksumFile: `${archive}.sha256`, sha256: checksum.split(' ')[0], bytes: archiveStat.size, archiveIntegrity: 'passed', requiredEntries: requiredEntries.length, packageSmoke, readiness: 'passed-before-packaging' }, null, 2));
