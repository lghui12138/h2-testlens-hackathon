...
function resolveApiConfig(payload) {
  ...
  const imported = profilesFromPackage(payload.profilePackage, { requireEvidenceLedger: true, evidenceRows: standardEvidenceRows });
