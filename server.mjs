...
function resolveApiConfig(payload) {
  ...
  return { ...profile.thresholds, profileId: profile.id, profileName: profile.name, profileSource: profile.source, profileOrganization: imported.organization, approvalStatus: profile.approvalStatus, applicationScope: profile.applicationScope, intendedUse: profile.intendedUse, methodId: profile.methodId, revision: profile.revision, standardRefs: profile.standardRefs, requiredMetadata: profile.requiredMetadata, requiredMeasurements: profile.requiredMeasurements, requiredPhases: profile.requiredPhases, acceptanceCriteria: profile.acceptanceCriteria, uncertaintyModelRequired: profile.uncertaintyModelRequired, uncertaintyModel: profile.uncertaintyModel, testMetadata: payload.testMetadata || {}, fieldMapping: imported.fieldMapping };
}
